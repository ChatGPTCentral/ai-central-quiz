...
const UI_META: Record<string, { axis?: string; secs?: string }> = {
  ...
  frequency: { axis: 'your habit', secs: '~40 sec' },
  hoursLost: { axis: 'the cost', secs: '~35 sec' },
  aiTools: { axis: 'your toolkit', secs: '~30 sec' },
  depth: { axis: 'your depth', secs: '~26 sec' },
  momentum: { axis: 'your momentum', secs: '~22 sec' },
  friction: { axis: 'your blocker', secs: '~18 sec' },
  hoursFor: { axis: 'the prize', secs: '~14 sec' },
