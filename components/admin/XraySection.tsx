...
//
// Extracted from app/admin/xray/page.tsx so the same section can render both
// as its own full page (/admin/xray) and embedded inside the main dashboard
// (owner, 2026-08-26: "perché non portiamo la x-ray dentro la dashboard" —
// a separate nav item was easy to never open). One component, one source of
// the SVG-building logic, both call sites render it unchanged.
//
...
export default async function XraySection() {
  const c = db()
