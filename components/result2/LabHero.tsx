...
export function LabHero({ variant, firstName, score, topPct, leverage, rungClassName, stageKey, aheadPct, checkoutUrl, submissionId }: LabHeroProps) {
  ...
  const V: Record<string, { eyebrow: string; headline: React.ReactNode; subline: React.ReactNode; caption: string; cta: string }> = {
    a: {
      ...
      subline: <>You use AI all the time, but it&rsquo;s barely working <em>for</em> you. The stages above are closer than they look.</>,
    ...
    b: {
      ...
      caption: 'Your next stage is ≈1 week away with the library.',
      cta: 'close the leverage gap',
    },
    c: {
      eyebrow: 'Your AI journey',
      headline: <>{Who}&rsquo;re <span style={{ color: FULVOUS }}>3 stages</span> from the top</>,
      ...
      caption: 'Each stage ≈1 week with the library.',
      cta: 'start the climb',
    },
    d: {
      eyebrow: 'Your result',
