...
export const QUESTIONS_V2_MERGED: V2Question[] = [
...

  {
    ...
    scoring: 'count',
    options: [
      { label: 'Asked ChatGPT, Claude, or Gemini a question', value: 'asked',          emoji: '💬' },
      { label: 'Saved a prompt to reuse later',               value: 'saved_prompt',   emoji: '📌' },
      { label: 'Used AI to make a real decision (research, hire, pricing, strategy)', value: 'decided', emoji: '🧭' },
      { label: 'Built a custom GPT or Claude Project',        value: 'custom_gpt',     emoji: '🛠️' },
      { label: 'Connected AI to another tool (Zapier, n8n, API)', value: 'connected',  emoji: '🔌' },
      { label: 'Shipped something AI-powered to a customer or team', value: 'shipped', emoji: '🚀' },
    ],
  },
